    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .bar-top-open { transform: translateY(7px) rotate(45deg) !important; background: #F5A800 !important; }
        .bar-mid-open { opacity: 0 !important; }
        .bar-bot-open { transform: translateY(-7px) rotate(-45deg) !important; background: #F5A800 !important; }

        /* ── SEARCH ── */
        .search-wrap:focus-within { border-color: rgba(245,168,0,0.6) !important; }
        ...
        .side-drawer {
          ...
          z-index: 1200;
          background: #0D0D0D;
          border-right: 1px solid rgba(245,168,0,0.1);
        ...
        .drawer-item:hover {
          ...
          border-left-color: rgba(245,168,0,0.4);
        }
        .drawer-item.active {
        ...
        .drawer-item.active .drawer-item-title { color: #F5A800; }
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div
            ...
            style={{ cursor: "pointer", display: "flex", flexDirection: "column", gap: 6, padding: 2 }}
          >
        ...
        <div
          ref={searchRef}
          style={{ flex: 1, maxWidth: isMobile ? "100%" : 360, margin: isMobile ? "0 12px" : "0 40px", position: "relative" }}
        >
          <div className="search-wrap" style={{
            ...
            <svg width="16" height="16" fill="none" stroke="rgba(245,168,0,0.65)" strokeWidth="2" viewBox="0 0 24 24">
            ...
            {query && (
              <span
                ...
                style={{ color: "rgba(255,255,255,0.35)", cursor: "pointer", fontSize: 20, lineHeight: 1 }}
              >×</span>
            )}
          </div>
          ...
          {showResults && (
            <div className="search-dropdown">
              ...
              {query.trim() ? (
                results.length > 0 ? (
                  <div>
                    {["Sermon", "Event", "Book"].map(type => {
                      ...
                      return (
                        <div key={type} style={{ padding: "18px 22px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                          {/* Section header */}
                          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                            <div style={{ fontFamily: "Cinzel,serif", fontSize: 17, fontWeight: 700, color: "#fff" }}>
                              {type}s
                            </div>
                            <button
                          ...
                          <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
                            {group.slice(0, 3).map((item, i) => (
                              <div key={i} className="sd-card" onClick={() => handleResultClick(item)}>
                                <div style={{
                                ...
                                <div style={{
                                  ...
                                  color: "#fff", lineHeight: 1.4, marginBottom: 6,
                                }}>
                                  {item.title}
                                </div>
                                <div style={{
                ...
                /* DEFAULT MODE — shown on focus with no query */
                <div>

                  {/* BOOKS */}
                  <div style={{ padding: "20px 22px 18px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                      <div style={{ fontFamily: "Cinzel,serif", fontSize: 17, fontWeight: 700, color: "#fff" }}>Books</div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
                      {[
                        ...
                        <div key={i} className="sd-card" onClick={() => { setShowResults(false); setQuery(""); goToPage("store", b.searchQ); }}>
                          <div style={{ width: "100%", height: isMobile ? 100 : 140, borderRadius: 6, overflow: "hidden", marginBottom: 10, background: "#1a1a1a" }}>
                            <img src={b.cover} alt={b.title} style={{ width: "100%", height: "100%", objectFit: "cover" }} className="sd-img" />
                          </div>
                          <div style={{ fontFamily: "Cinzel,serif", fontSize: 13, fontWeight: 700, color: "#fff", lineHeight: 1.4 }}>
                            {b.title}
                          </div>
                        </div>
                      ))}
                  ...
                  <div style={{ padding: "20px 22px 18px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                      <div style={{ fontFamily: "Cinzel,serif", fontSize: 17, fontWeight: 700, color: "#fff" }}>Sermons</div>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 14 }}>
                      {defaultVideoSermons.slice(0, 3).map((s, i) => (
                        ...
                        >
                          <div style={{ width: "100%", height: isMobile ? 80 : 110, borderRadius: 6, overflow: "hidden", marginBottom: 10, background: "#1a1a1a" }}>
                            <img
                          ...
                          <div style={{ fontFamily: "Cinzel,serif", fontSize: 13, fontWeight: 700, color: "#fff", lineHeight: 1.4, marginBottom: 4 }}>
                            {s.title}
                          </div>
                          <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.45)" }}>
                            {s.preacher}
                          </div>
                        </div>
                      ))}
                  ...
                  <div style={{ padding: "20px 22px 22px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
                      <div style={{ fontFamily: "Cinzel,serif", fontSize: 17, fontWeight: 700, color: "#fff" }}>Events</div>
          ...
          <div ref={userRef} style={{ position: "relative" }}>
            ...
            >
              {user ? (
                <div style={{
                  width: 40, height: 40, borderRadius: "50%",
                  background: "linear-gradient(135deg,#6B21A8,#F5A800)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontFamily: "Cinzel,serif", fontWeight: 700, fontSize: 15, color: "#000",
                }}>
                  {user.name?.charAt(0).toUpperCase() || "U"}
                </div>
              ) : (
                <svg width="18" height="18" fill="none" stroke="rgba(255,255,255,0.7)" strokeWidth="1.5" viewBox="0 0 24 24">
            ...
            {user && (
              <div className={`user-mini-menu ${userMenu ? "open" : ""}`}>
                <div style={{ padding: "16px 18px 12px", borderBottom: "1px solid rgba(245,168,0,0.08)" }}>
                  <div style={{ fontFamily: "Cinzel,serif", fontSize: 15, fontWeight: 600, color: "#fff" }}>
                    {user.name}
                  </div>
                  <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 13, color: "rgba(255,255,255,0.38)", letterSpacing: 1 }}>
                    {user.email}
                  </div>
                </div>
      ...
      {isMobile && (
        <nav className="top-tab-bar">
          {[
            { label: "Home",      navigate: "home",    icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M3 12l9-9 9 9M5 10v9a1 1 0 001 1h4v-5h4v5h4a1 1 0 001-1v-9"/></svg> },
            { label: "Sermons",   navigate: "sermons", icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M15 10l4.553-2.069A1 1 0 0121 8.87V18.5a1 1 0 01-1.447.894L15 17M3 8h12v10H3a1 1 0 01-1-1V9a1 1 0 011-1z"/></svg> },
            { label: "Streaming", navigate: "streams", icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M5 12.55a11 11 0 0114.08 0M1.42 9a16 16 0 0121.16 0M8.53 16.11a6 6 0 016.95 0M12 20h.01"/></svg> },
            { label: "Giving",    navigate: "give",    icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg> },
            { label: "About",     navigate: "about",   icon: <svg width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg> },
          ].map((tab, i) => (
      ...
      <div className={`side-drawer ${menuOpen ? "open" : ""}`}>
        ...
        <div className="drawer-header">
          <img src={logo} alt="Zoe Logo" style={{ height: 40, objectFit: "contain" }} />
        ...
        {connectItems.map((item, i) => (
          <div
            key={i}
            className={`drawer-item ${activeItem === item.title ? "active" : ""}`}
        ...
        <div
          ...
          onClick={() => { onNavigate("issues"); setMenuOpen(false); }}
        >
          <div style={{ width: 40, height: 40, borderRadius: 8, background: "rgba(255,255,255,0.04)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            <svg width="18" height="18" fill="none" stroke="rgba(255,255,255,0.45)" strokeWidth="1.5" viewBox="0 0 24 24">
              <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>
            </svg>
          </div>
          <div>
            <div style={{ fontFamily: "Cinzel,serif", fontSize: 15, fontWeight: 600, color: "rgba(255,255,255,0.75)" }}>
              Notice an issue?
            </div>
            <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 13, color: "rgba(255,255,255,0.35)" }}>
        ...
        <div className="my-portal-box">
          ...
          <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 14, color: "rgba(255,255,255,0.45)", lineHeight: 1.7, letterSpacing: 0.3 }}>
          ...
          <a href="https://t.me/+KtrkQ-ACzkNlNTFk" className="portal-btn" onClick={() => setMenuOpen(false)}>
            Access MyZoe ↗
          </a>
        </div>

        {/* ADDRESS & CONTACT */}
        <div style={{ padding: "22px 20px 10px", borderTop: "1px solid rgba(245,168,0,0.08)", marginTop: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12, color: "rgba(255,255,255,0.7)", fontFamily: "Rajdhani,sans-serif", fontSize: 15 }}>
            <MdLocationOn size={18} style={{ color: "#F5A800", flexShrink: 0 }} />
            <span>Lagos, Nigeria</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8, color: "rgba(255,255,255,0.65)", fontFamily: "Rajdhani,sans-serif", fontSize: 15 }}>
            <MdPhone size={17} style={{ color: "#F5A800", flexShrink: 0 }} />
            <span>+234 703 610 0912</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, color: "rgba(255,255,255,0.65)", fontFamily: "Rajdhani,sans-serif", fontSize: 15 }}>
            <MdPhone size={17} style={{ color: "#F5A800", flexShrink: 0 }} />
            <span>+234 817 929 7984</span>
          </div>
            ...
            {[
              ...
              <a
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.borderColor = "rgba(245,168,0,0.45)";
                  e.currentTarget.style.background = "rgba(245,168,0,0.08)";
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.transform = "translateY(0)";
                  e.currentTarget.style.borderColor = "rgba(245,168,0,0.15)";
          ...
          <div style={{ width: 70, height: 1, background: "linear-gradient(90deg,transparent,rgba(245,168,0,0.4),transparent)", marginBottom: 14 }} />
          <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 13, color: "rgba(255,255,255,0.42)", letterSpacing: "0.8px", textTransform: "uppercase" }}>
            © 2026 Zoe School of Mysteries
          </div>
          <div style={{ fontFamily: "Rajdhani,sans-serif", fontSize: 12, color: "rgba(255,255,255,0.25)", marginTop: 4, letterSpacing: "0.5px" }}>
            All Rights Reserved
          </div>
        </div>
        ...
        <div className="drawer-footer">
          <a
            href="#give"
            className="drawer-give-btn"
            onClick={e => { e.preventDefault(); setMenuOpen(false); onNavigate?.("give"); }}
          >
            Give Now
          </a>
        </div>
