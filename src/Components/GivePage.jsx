...
//         {/* verse text: 17 → 19px */}
//         <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:19,fontStyle:"italic",fontWeight:400,color:"rgba(255,255,255,0.75)",lineHeight:1.8,marginBottom:12,position:"relative",zIndex:1}}>"{verse.verse}"</p>
//         {/* verse ref: 11 → 13px */}
//         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:3,textTransform:"uppercase",color:"#F5A800",fontWeight:700}}>— {verse.ref}</div>
...
//         {/* prayer heading: 13 → 15px */}
//         <div style={{fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,color:"#9333EA",marginBottom:8,letterSpacing:0.5}}>🙏 A Prayer Before You Give</div>
//         {/* prayer body: 15 → 17px */}
//         <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:17,fontStyle:"italic",fontWeight:300,color:"rgba(255,255,255,0.5)",lineHeight:1.8,margin:0}}>
...
//         {/* security label: 10 → 12px */}
//         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.18)",fontWeight:700}}>All transactions are encrypted &amp; secure</div>
//       </div>
//     </div>
//   );
// }
...
//         .gp-pill{border-radius:4px;padding:14px 8px;cursor:pointer;border:1px solid rgba(255,255,255,0.08);background:rgba(255,255,255,0.02);font-family:'Cinzel',serif;font-size:16px;font-weight:700;color:rgba(255,255,255,0.5);text-align:center;transition:all 0.25s;}
...
//         .gp-input{width:100%;background:rgba(245,168,0,0.04);border:1px solid rgba(245,168,0,0.15);border-radius:4px;padding:14px 16px;color:#fff;font-family:'Rajdhani',sans-serif;font-size:16px;letter-spacing:0.5px;outline:none;transition:border-color 0.3s,box-shadow 0.3s;box-sizing:border-box;}
...
//         .gp-step{width:32px;height:32px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-family:'Cinzel',serif;font-size:13px;font-weight:700;transition:all 0.4s;}
...
//         .gp-freq{flex:1;padding:10px;border:none;cursor:pointer;font-family:'Rajdhani',sans-serif;font-size:13px;letter-spacing:2px;text-transform:uppercase;font-weight:700;background:transparent;color:rgba(255,255,255,0.3);transition:all 0.25s;border-bottom:2px solid transparent;}
//         .gp-freq.active{color:#F5A800;border-bottom-color:#F5A800;}
//         .gp-back{background:none;border:none;cursor:pointer;font-family:'Rajdhani',sans-serif;font-size:13px;letter-spacing:2px;text-transform:uppercase;font-weight:700;color:rgba(255,255,255,0.35);display:flex;align-items:center;gap:6px;padding:0;margin-bottom:24px;transition:color 0.2s;}
...
//         .gp-eyebrow{display:flex;align-items:center;gap:10px;font-family:'Rajdhani',sans-serif;font-size:13px;letter-spacing:5px;text-transform:uppercase;color:#F5A800;margin-bottom:16px;}
...
//         .gp-checkbox{width:20px;height:20px;border:2px solid rgba(245,168,0,0.4);border-radius:3px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all 0.2s;flex-shrink:0;}
//         .gp-checkbox.checked{background:#F5A800;border-color:#F5A800;}
//         .paystack-btn-wrapper button{width:100% !important;padding:18px !important;background:linear-gradient(135deg,#C88600,#F5A800,#FFD166,#F5A800) !important;background-size:300% auto !important;color:#000 !important;border:none !important;border-radius:4px !important;font-family:'Cinzel',serif !important;font-size:15px !important;letter-spacing:3px !important;text-transform:uppercase !important;font-weight:900 !important;cursor:pointer !important;transition:all 0.4s !important;}
...
//             </h1>
//             <p className="gp-in" style={{fontFamily:"Cormorant Garamond,serif",fontSize:isMobile?18:22,fontStyle:"italic",fontWeight:300,color:"rgba(255,255,255,0.6)",lineHeight:1.7,maxWidth:440,marginBottom:36,animationDelay:"0.2s"}}>
...
//                   {/* stat sub-label: 9 → 11px */}
//                   <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:11,letterSpacing:3,textTransform:"uppercase",color:"rgba(255,255,255,0.3)",fontWeight:600}}>{s.sub}</div>
//                 </div>
//               ))}
//             </div>
//             <div className="gp-in" style={{marginTop:36,animationDelay:"0.5s"}}>
//               <button className="gp-submit" style={{width:"auto",padding:"16px 48px",fontSize:13}} onClick={()=>document.getElementById("give-form")?.scrollIntoView({behavior:"smooth"})}>
//                 Give Now
...
//                       {/* step label: 9 → 11px */}
//                       <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:step===i+1?"#F5A800":"rgba(255,255,255,0.2)",fontWeight:700}}>{label}</div>
//                     </div>
...
//                 {/* h2: 24–32 → 28–36px */}
//                 <h2 style={{fontFamily:"Cinzel,serif",fontSize:isMobile?28:36,fontWeight:700,color:"#fff",marginBottom:8}}>Where Does Your Seed Go?</h2>
//                 {/* subtitle: 16 → 18px */}
//                 <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:18,fontStyle:"italic",color:"rgba(255,255,255,0.4)",marginBottom:28}}>Choose the ground where you want to plant your faith.</p>
...
//                       {/* fund card title: 12 → 14px */}
//                       <div style={{fontFamily:"Cinzel,serif",fontSize:14,fontWeight:700,color:selectedFund===f.id?f.color:"rgba(255,255,255,0.7)",transition:"color 0.3s",letterSpacing:0.5}}>{f.title}</div>
...
//                 <h2 style={{fontFamily:"Cinzel,serif",fontSize:isMobile?28:36,fontWeight:700,color:"#fff",marginBottom:8}}>How Much Are You Sowing?</h2>
//                 <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:18,fontStyle:"italic",color:"rgba(255,255,255,0.4)",marginBottom:28}}>Planting into: <span style={{color:fund?.color}}>{fund?.icon} {fund?.title}</span></p>
...
//                       {/* custom amount link: 11 → 13px */}
//                       <span style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,color:"rgba(255,255,255,0.25)",cursor:"pointer",textTransform:"uppercase",textDecoration:"underline"}} onClick={()=>setCustom(true)}>Enter custom amount</span>
//                     </div>
//                   </>
//                 ):(
//                   <div style={{textAlign:"center",marginBottom:28}}>
//                     {/* amount label: 10 → 12px */}
//                     <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:4,color:"rgba(255,255,255,0.25)",marginBottom:8,textTransform:"uppercase"}}>AMOUNT (₦)</div>
//                     <input className="gp-amt-input" type="number" placeholder="0" value={amount} onChange={e=>setAmount(e.target.value)} />
//                     <div style={{marginTop:12}}>
//                       <span style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,color:"rgba(255,255,255,0.25)",cursor:"pointer",textTransform:"uppercase",textDecoration:"underline"}} onClick={()=>{setCustom(false);setAmount("");}}>Choose preset</span>
//                     </div>
//                   </div>
//                 )}
//                 {amount>0&&(
...
//                       {/* summary italic: 15 → 17px */}
//                       <div style={{fontFamily:"Cormorant Garamond,serif",fontSize:17,fontStyle:"italic",color:"rgba(255,255,255,0.45)"}}>{frequency==="once"?"One-time":frequency} · {fund?.title}</div>
...
//                 <h2 style={{fontFamily:"Cinzel,serif",fontSize:isMobile?28:36,fontWeight:700,color:"#fff",marginBottom:8}}>Complete Your Gift</h2>
//                 <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:18,fontStyle:"italic",color:"rgba(255,255,255,0.4)",marginBottom:28}}>
...
//                   <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:4,textTransform:"uppercase",color:"rgba(255,255,255,0.25)",marginBottom:14}}>Payment Method</div>
...
//                         {/* pay method label: 10 → 12px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:1,fontWeight:700,textTransform:"uppercase",color:payMethod===m.id?"#F5A800":"rgba(255,255,255,0.4)",textAlign:"center",transition:"color 0.3s"}}>{m.label}</div>
//                         {/* pay method sub: 9 → 11px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:11,color:"rgba(255,255,255,0.2)",textAlign:"center"}}>{m.sub}</div>
//                       </div>
//                     ))}
//                   </div>
//                 </div>
...
//                       {/* bank section label: 10 → 12px */}
//                       <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:3,textTransform:"uppercase",color:"rgba(255,255,255,0.3)",marginBottom:14}}>🏦 Transfer Details — Fidelity Bank</div>

//                       <div style={{padding:"10px 0",borderBottom:"1px solid rgba(255,255,255,0.06)",marginBottom:4}}>
//                         {/* account label: 9 → 11px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.25)",marginBottom:4}}>Account Name</div>
//                         {/* account name: 14 → 16px */}
//                         <div style={{fontFamily:"Cinzel,serif",fontSize:16,fontWeight:700,color:"#F5A800"}}>Creative School of Light LTD/GTE</div>
//                       </div>
...
//                           {/* currency label: 11 → 13px */}
//                           <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.35)",fontWeight:700}}>{acc.currency}</div>
//                           <div style={{display:"flex",alignItems:"center",gap:10}}>
//                             {/* account number: 13 → 15px */}
//                             <div style={{fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,color:"#fff"}}>{acc.number}</div>
//                             <button
//                               onClick={()=>handleCopy(acc.number,i)}
//                               style={{background:copiedIndex===i?"rgba(34,197,94,0.15)":"rgba(245,168,0,0.1)",border:`1px solid ${copiedIndex===i?"rgba(34,197,94,0.4)":"rgba(245,168,0,0.2)"}`,borderRadius:3,padding:"4px 10px",cursor:"pointer",fontFamily:"Rajdhani,sans-serif",fontSize:11,letterSpacing:1,color:copiedIndex===i?"#22c55e":"#F5A800",textTransform:"uppercase",transition:"all 0.2s"}}>
...
//                       {/* confirm section label: 10 → 12px */}
//                       <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:3,textTransform:"uppercase",color:"rgba(255,255,255,0.3)",marginBottom:16}}>✅ Confirm Your Transfer</div>

//                       <div style={{marginBottom:14}}>
//                         {/* last 4 label: 11 → 13px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:1,color:"rgba(255,255,255,0.45)",marginBottom:8}}>Last 4 digits of the account you sent from *</div>
//                         <input
//                           className="gp-input"
...
//                       <div style={{marginBottom:14}}>
//                         {/* receipt label: 11 → 13px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:1,color:"rgba(255,255,255,0.45)",marginBottom:8}}>
...
//                             {/* upload label: 12 → 14px */}
//                             <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:14,letterSpacing:1,color:"rgba(255,255,255,0.35)"}}>Tap to upload screenshot or PDF</div>
//                             <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,color:"rgba(255,255,255,0.2)",marginTop:4}}>JPG, PNG or PDF</div>
//                           </label>
//                         )}
//                       </div>
...
//                           {confirmed&&<span style={{color:"#000",fontSize:13,fontWeight:700}}>✓</span>}
//                         </div>
//                         {/* checkbox label: 12 → 14px */}
//                         <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:14,color:"rgba(255,255,255,0.5)",lineHeight:1.6,userSelect:"none"}}>
...
//                     {/* WhatsApp info note */}
//                     <div style={{marginTop:10,padding:"14px 16px",background:"rgba(34,197,94,0.06)",border:"1px solid rgba(34,197,94,0.2)",borderRadius:6,fontFamily:"Rajdhani,sans-serif",fontSize:13,color:"rgba(255,255,255,0.5)",lineHeight:2}}>
//                       {/* note heading: 12 → 14px */}
//                       <div style={{color:"#22c55e",fontWeight:700,fontSize:14,marginBottom:4}}>📲 What happens when you click Submit:</div>
...
//                       {/* warning: 10 → 12px */}
//                       <div style={{marginTop:6,color:"rgba(255,255,255,0.3)",fontSize:12,letterSpacing:1}}>⚠️ Browsers cannot auto-attach files to WhatsApp — you must attach it manually in step 3.</div>
//                     </div>

//                     {/* help note: 11 → 13px */}
//                     <div style={{marginTop:8,padding:"10px 14px",background:"rgba(245,168,0,0.04)",borderRadius:4,fontFamily:"Rajdhani,sans-serif",fontSize:13,color:"rgba(255,255,255,0.35)",lineHeight:1.6}}>
...
//                       {/* summary label: 10 → 12px */}
//                       <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.3)"}}>{r.l}</div>
//                       {/* summary value: 13 → 15px */}
//                       <div style={{fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,color:r.gold?"#F5A800":"#fff"}}>{r.v}</div>
//                     </div>
//                   ))}
//                 </div>
...
//                   <div style={{textAlign:"center",marginTop:10,fontFamily:"Rajdhani,sans-serif",fontSize:13,color:"rgba(239,68,68,0.6)",letterSpacing:1}}>
...
//                 {/* security note: 10 → 12px */}
//                 <div style={{textAlign:"center",marginTop:12,fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:1,color:"rgba(255,255,255,0.15)"}}>
...
//                 </div>
//                 <h2 style={{fontFamily:"Cinzel,serif",fontSize:isMobile?28:36,fontWeight:700,color:"#fff",marginBottom:10}}>Thank You, {name.split(" ")[0]}! 🙏</h2>
//                 {/* success message: 18 → 20px */}
//                 <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:20,fontStyle:"italic",color:"rgba(255,255,255,0.55)",maxWidth:400,margin:"0 auto 28px",lineHeight:1.8}}>
...
//                 {payMethod==="transfer"&&(
//                   <>
//                     <div style={{background:"rgba(34,197,94,0.07)",border:"1px solid rgba(34,197,94,0.25)",borderRadius:6,padding:"16px 20px",marginBottom:12,fontFamily:"Rajdhani,sans-serif",fontSize:14,color:"rgba(255,255,255,0.6)",lineHeight:2,textAlign:"left",maxWidth:420,margin:"0 auto 12px"}}>
//                       <div style={{color:"#22c55e",fontWeight:700,fontSize:15,marginBottom:6}}>📲 3 Quick Steps to Complete:</div>
...
//                       <div style={{marginTop:8,fontSize:12,color:"rgba(255,255,255,0.3)",letterSpacing:1}}>Sending to: 07036100912</div>
//                     </div>
//                     <div style={{background:"rgba(245,168,0,0.08)",border:"1px solid rgba(245,168,0,0.25)",borderRadius:4,padding:"12px 24px",marginBottom:16,fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,color:"#F5A800",display:"block",maxWidth:420,margin:"0 auto 16px"}}>
//                       ⏳ We'll confirm your transfer within 24 hours
//                     </div>
//                   </>
//                 )}
//                 <div style={{display:"block",background:"rgba(34,197,94,0.08)",border:"1px solid rgba(34,197,94,0.25)",borderRadius:4,padding:"12px 24px",marginBottom:32,fontFamily:"Rajdhani,sans-serif",fontSize:14,letterSpacing:2,color:"#22c55e"}}>
//                   ✓ Record saved successfully
//                 </div>
//                 <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
//                   <button className="gp-submit" style={{width:"auto",padding:"14px 36px",fontSize:13}} onClick={reset}>Give Again</button>
//                   <button onClick={reset} style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:3,textTransform:"uppercase",fontWeight:700,color:"rgba(255,255,255,0.5)",background:"transparent",border:"1px solid rgba(255,255,255,0.12)",padding:"14px 36px",borderRadius:4,cursor:"pointer"}}>Back to Home</button>
//                 </div>
//               </div>
//             )}
//           </div>
...
//               {/* FAQ heading: 32–48 stays (already large) */}
...
//                       {/* FAQ question: 17–20 → 19–22px */}
//                       <span style={{fontFamily:"Cormorant Garamond,serif",fontSize:isMobile?19:22,fontWeight:400,color:openFaq===i?"#F5A800":"#fff",lineHeight:1.4,transition:"color 0.3s",flex:1}}>{faq.q}</span>
...
//                       {/* FAQ answer: 15–17 → 17–19px */}
//                       <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:isMobile?17:19,fontWeight:300,color:"rgba(255,255,255,0.55)",lineHeight:1.8,paddingBottom:24,paddingRight:isMobile?0:40}}>{faq.a}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//                 <div>
//                   {/* CTA heading: 16 → 18px */}
//                   <div style={{fontFamily:"Cinzel,serif",fontSize:18,fontWeight:700,color:"#fff",marginBottom:6}}>Still have questions?</div>
//                   {/* CTA sub: 15 → 17px */}
//                   <div style={{fontFamily:"Cormorant Garamond,serif",fontSize:17,fontStyle:"italic",color:"rgba(255,255,255,0.45)"}}>Our team is happy to help you with anything giving-related.</div>
//                 </div>
//                 <div style={{display:"flex",gap:10,flexWrap:"wrap"}}>
//                   <a href="https://wa.me/2347082129744" target="_blank" rel="noreferrer" style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,textTransform:"uppercase",fontWeight:700,color:"#000",background:"#22c55e",padding:"12px 20px",borderRadius:2,textDecoration:"none",whiteSpace:"nowrap",flexShrink:0}}>💬 WhatsApp 1</a>
//                   <a href="https://wa.me/2349167212492" target="_blank" rel="noreferrer" style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,textTransform:"uppercase",fontWeight:700,color:"#000",background:"#22c55e",padding:"12px 20px",borderRadius:2,textDecoration:"none",whiteSpace:"nowrap",flexShrink:0}}>💬 WhatsApp 2</a>
//                 </div>
//               </div>
//             </div>
...
//                       style={{display:"block",fontFamily:"Rajdhani,sans-serif",fontSize:16,fontWeight:activeSection===item.id?700:500,letterSpacing:0.5,color:activeSection===item.id?"#fff":"rgba(255,255,255,0.4)",textDecoration:"none",padding:"10px 0 10px 16px",borderLeft:`2px solid ${activeSection===item.id?"#F5A800":"transparent"}`,transition:"all 0.25s",marginBottom:4}}
...
const FLUTTERWAVE_PUBLIC_KEY = "FLWPUBK-d4fdb8ac76d502e20635fff4bb389806-X"; // swap for your real key

function FlutterwaveGiveButton({ amount, currency, name, email, phone, fundTitle, onSuccess, currencySymbol }) {
  const config = {
    public_key: FLUTTERWAVE_PUBLIC_KEY,
    tx_ref: `zoe_flw_${Date.now()}`,
    amount: Number(amount),
    ...
    customizations: {
      ...
      description: `Giving towards ${fundTitle}`,
      logo: "",
    },
  };
  ...
  return (
    <div className="flutterwave-btn-wrapper">
      <button
        type="button"
        disabled={!name || !email}
        onClick={() => {
      ...
      >
        Give {currencySymbol}{Number(amount).toLocaleString()} Now 🙏
      </button>
    </div>
  );
}
...
const faqs = [
  { q:"How can I make a donation?", a:"You can give by using our secure online payment option through Paystack or Flutterwave (card, bank transfer, USSD) or by sending your donation manually through the bank account details provided on this page." },
  { q:"Is my payment through Paystack or Flutterwave secure?", a:"Yes. Both Paystack and Flutterwave provide fully encrypted and secure payment systems that protect your payment information during every transaction." },
  { q:"How do I donate through Paystack or Flutterwave?", a:'Click on the "Give Now" button, select your fund, enter your donation amount, choose Paystack or Flutterwave as your payment method, fill in your details, and follow the payment instructions to complete your transaction.' },
  { q:"How can I give through bank transfer?", a:'Select "Bank Transfer" as your payment method on the giving page. The bank account details for Fidelity Bank will be displayed. Send your donation, then submit your payment proof for confirmation.' },
  { q:"I made a bank transfer, how do I confirm my donation?", a:"After completing the transfer, upload your payment receipt, enter the last 4 digits of the account you sent from, and confirm your submission. You can also reach us on WhatsApp at 07082129744 or 09167212492." },
  { q:"Can I donate any amount?", a:"Yes. You can give any amount you feel led to sow. Every seed — no matter how small — supports the mission and vision of Zoe School of Mysteries." },
  { q:"My payment failed. What should I do?", a:"Check your internet connection and ensure your card or account details are correct, then try again. If the issue continues, contact us on WhatsApp at 07082129744 or 09167212492." },
  { q:"My money was deducted but my donation is not showing. What should I do?", a:"Please wait a few minutes for payment confirmation to process. If it still does not update, contact us on WhatsApp with your transaction reference and we will resolve it promptly." },
  { q:"Can I donate from another country?", a:"Yes! Flutterwave and Paystack support eligible international card payments in NGN, USD, GBP, and EUR. We also have USD, GBP, and EUR Fidelity Bank accounts for direct international transfers. Contact us on WhatsApp for assistance." },
  { q:"Will I receive confirmation after giving?", a:"Yes. After your donation is confirmed, you will receive an acknowledgement. For Paystack and Flutterwave payments, you will see a success screen immediately after payment." },
  { q:"Is my donation refundable?", a:"Donations are generally considered final as they go directly to support the ministry. If there is an issue with a transaction, please contact us on WhatsApp at 07082129744 or 09167212492 for assistance." },
  { q:"Who can I contact if I have problems with giving?", a:"Contact our support team on WhatsApp: 07082129744 or 09167212492. We are happy to assist you with any giving-related questions." },
];
...
// ── APPROX EXCHANGE RATES (relative to 1 NGN) ──
// NOTE: these are static placeholder rates. Swap this out for a live FX API
// (e.g. exchangerate-api.com, openexchangerates.org) and cache the result,
// or update this table periodically — otherwise converted amounts will drift
// from the real market rate over time.
...
function convertFromNGN(ngnAmount, targetCode) {
  const rate = NGN_EXCHANGE_RATES[targetCode];
  if (!rate || !ngnAmount) return 0;
  return ngnAmount * rate;
}

// ── SEARCHABLE CURRENCY DROPDOWN ──
function CurrencySearchSelect({ value, onChange, options }) {
  ...
  return (
    <div ref={wrapRef} style={{ position: "relative" }}>
      ...
      {open && (
        <div style={{
          position: "absolute", top: "calc(100% + 6px)", right: 0, width: 240, zIndex: 30,
          background: "#0a0700", border: "1px solid rgba(245,168,0,0.3)", borderRadius: 6,
          boxShadow: "0 12px 36px rgba(0,0,0,0.65)", display: "flex", flexDirection: "column",
        }}>
          <input
            autoFocus
            value={query}
            ...
            style={{
              margin: 8, padding: "9px 10px", background: "rgba(245,168,0,0.06)",
              border: "1px solid rgba(245,168,0,0.2)", borderRadius: 4, color: "#fff",
              fontFamily: "Rajdhani,sans-serif", fontSize: 13, outline: "none", boxSizing: "border-box",
            }}
          />
          <div style={{ overflowY: "auto", maxHeight: 240 }}>
            {filtered.length === 0 && (
              <div style={{ padding: "12px 14px", color: "rgba(255,255,255,0.3)", fontSize: 13, fontFamily: "Rajdhani,sans-serif" }}>
                No matches
              </div>
            )}
            {filtered.map(o => (
              <div
                ...
                style={{
                  padding: "9px 14px", cursor: "pointer", fontFamily: "Rajdhani,sans-serif", fontSize: 13,
                  color: o.code === value ? "#F5A800" : "rgba(255,255,255,0.75)",
                  background: o.code === value ? "rgba(245,168,0,0.1)" : "transparent",
                  display: "flex", justifyContent: "space-between", gap: 10,
                }}
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(245,168,0,0.14)"; }}
                onMouseLeave={e => { e.currentTarget.style.background = o.code === value ? "rgba(245,168,0,0.1)" : "transparent"; }}
              >
                <span style={{ fontWeight: 700, flexShrink: 0 }}>{o.symbol} {o.code}</span>
                <span style={{ color: "rgba(255,255,255,0.35)", textAlign: "right" }}>{o.label}</span>
              </div>
            ))}
          </div>
        </div>
...
export default function GivePage() {
  ...
  // Only Flutterwave supports multi-currency here — reset back to NGN
  // whenever a different payment method is chosen so Paystack / bank
  // transfer always stay in Naira.
  useEffect(() => {
    if (payMethod !== "flutterwave" && currency !== "NGN") {
      setCurrency("NGN");
    }
  }, [payMethod]);

  // Amount entered in step 2 is always in NGN. When Flutterwave + a
  // non-NGN currency is selected, this is what actually gets charged.
  const flutterwaveChargeAmount = currency === "NGN"
    ? Number(amount)
    : convertFromNGN(Number(amount), currency);
  ...
  const onFlutterwaveSuccess = async (response) => {
    setProcessing(true);
    try {
      await saveGiving({
        uid: auth.currentUser?.uid || null,
        name, email, phone,
        amount: flutterwaveChargeAmount,
        currency,
        fund: selectedFund,
        frequency,
        method: "flutterwave",
        reference: response.tx_ref || response.transaction_id,
        status: "confirmed",
        createdAt: new Date(),
      });
      setStep(4);
  ...
  const handleManualPay = async () => {
    ...
    try {
      ...
      const msg = encodeURIComponent(
        ...
        `*Phone:* ${phone || "—"}\n` +
        `*Fund:* ${fund?.title}\n` +
        `*Amount:* ${currencySymbol}${Number(amount).toLocaleString()} (${currency})\n` +
        `*Frequency:* ${frequency === "once" ? "One-time" : frequency}\n` +
        `*Last 4 digits of sending account:* ${last4Digits}\n\n` +
        `📎 *Receipt is attached as the next message.*`
      );
  ...
  const reset = () => {
    setStep(1); setAmount(""); setName(""); setEmail(""); setPhone("");
    setCustom(false); setPayMethod("paystack"); setCurrency("NGN");
    setReceiptFile(null); setReceiptPreview(null);
    setLast4Digits(""); setConfirmed(false);
  };
  ...
  return (
    <>
      <style>{`
        ...
        .gp-checkbox{width:20px;height:20px;border:2px solid rgba(245,168,0,0.4);border-radius:3px;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all 0.2s;flex-shrink:0;}
        .gp-checkbox.checked{background:#F5A800;border-color:#F5A800;}
        .gp-currency-select{background:rgba(245,168,0,0.06);border:1px solid rgba(245,168,0,0.25);border-radius:4px;padding:10px 10px;color:#F5A800;font-family:'Rajdhani',sans-serif;font-size:13px;font-weight:700;letter-spacing:1px;cursor:pointer;outline:none;}
        .paystack-btn-wrapper button, .flutterwave-btn-wrapper button{width:100% !important;padding:18px !important;background:linear-gradient(135deg,#C88600,#F5A800,#FFD166,#F5A800) !important;background-size:300% auto !important;color:#000 !important;border:none !important;border-radius:4px !important;font-family:'Cinzel',serif !important;font-size:15px !important;letter-spacing:3px !important;text-transform:uppercase !important;font-weight:900 !important;cursor:pointer !important;transition:all 0.4s !important;}
        .paystack-btn-wrapper button:hover, .flutterwave-btn-wrapper button:hover{background-position:right center !important;transform:translateY(-3px) !important;box-shadow:0 10px 40px rgba(245,168,0,0.5) !important;}
        .paystack-btn-wrapper button:disabled, .flutterwave-btn-wrapper button:disabled{opacity:0.5 !important;cursor:not-allowed !important;}
      `}</style>
          ...
          <div>
              ...
              <div style={{animation:"gp-slideIn 0.5s ease forwards"}}>
                ...
                <div style={{marginBottom:28}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14,flexWrap:"wrap",gap:10}}>
                    <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:4,textTransform:"uppercase",color:"rgba(255,255,255,0.25)"}}>Payment Method</div>

                    {/* Currency picker only makes sense for Flutterwave — Paystack and
                        bank transfer are NGN-only on this setup. */}
                    {payMethod==="flutterwave"&&(
                      <CurrencySearchSelect value={currency} onChange={setCurrency} options={currencyOptions} />
                    )}
                  </div>
                  <div style={{display:"flex",gap:10,flexWrap:isMobile?"wrap":"nowrap"}}>
                    {[
                      {id:"paystack",label:"Paystack Card / USSD",logo:"💳",sub:"Pay instantly online"},
                      {id:"flutterwave",label:"Flutterwave",logo:"🌊",sub:"Card / Bank / Mobile"},
                      {id:"transfer",label:"Bank Transfer",logo:"🏦",sub:"Send directly to us"},
                    ].map(m=>(
                      <div key={m.id} className={`gp-pay ${payMethod===m.id?"sel":""}`} style={{minWidth:isMobile?"30%":"auto"}} onClick={()=>setPayMethod(m.id)}>
                        <div style={{fontSize:24}}>{m.logo}</div>
                        <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:1,fontWeight:700,textTransform:"uppercase",color:payMethod===m.id?"#F5A800":"rgba(255,255,255,0.4)",textAlign:"center",transition:"color 0.3s"}}>{m.label}</div>
                        <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:11,color:"rgba(255,255,255,0.2)",textAlign:"center"}}>{m.sub}</div>
                      </div>
                  ...
                  {/* Live conversion preview — amount is always entered in NGN,
                      this shows what it works out to in the chosen currency. */}
                  {payMethod==="flutterwave"&&currency!=="NGN"&&Number(amount)>0&&(
                    <div style={{marginTop:12,padding:"10px 14px",background:"rgba(245,168,0,0.05)",border:"1px solid rgba(245,168,0,0.18)",borderRadius:4,fontFamily:"Rajdhani,sans-serif",fontSize:13,color:"rgba(255,255,255,0.55)"}}>
                      ₦{Number(amount).toLocaleString()} ≈ <span style={{color:"#F5A800",fontWeight:700}}>
                        {currencySymbol}{flutterwaveChargeAmount.toLocaleString(undefined,{maximumFractionDigits:2})} {currency}
                      </span>
                      <div style={{fontSize:11,color:"rgba(255,255,255,0.25)",marginTop:2}}>Approximate — you'll be charged this amount in {currency}, based on current rates.</div>
                    </div>
                  )}
                </div>
                ...
                {payMethod==="transfer"&&(
                  <div style={{marginBottom:20}}>
                    ...
                    <div style={{background:"rgba(245,168,0,0.04)",border:"1px solid rgba(245,168,0,0.2)",borderRadius:8,padding:18,marginBottom:16}}>
                      ...
                      {bankAccounts.filter(acc=>acc.currency.startsWith(currency)).concat(bankAccounts.filter(acc=>!acc.currency.startsWith(currency))).map((acc,i)=>(
                        <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 0",borderBottom:i<bankAccounts.length-1?"1px solid rgba(255,255,255,0.05)":"none"}}>
                          <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:13,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.35)",fontWeight:700}}>{acc.currency}</div>
                          <div style={{display:"flex",alignItems:"center",gap:10}}>
                            <div style={{fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,color:"#fff"}}>{acc.number}</div>
                ...
                <div style={{background:"rgba(245,168,0,0.04)",border:"1px solid rgba(245,168,0,0.12)",borderRadius:6,padding:16,marginBottom:24}}>
                  {[
                    {l:"Fund",      v:`${fund?.icon} ${fund?.title}`},
                    {l:"Amount",    v: payMethod==="flutterwave" && currency!=="NGN"
                        ? `${currencySymbol}${flutterwaveChargeAmount.toLocaleString(undefined,{maximumFractionDigits:2})} ${currency}`
                        : `₦${Number(amount).toLocaleString()}`,gold:true},
                    {l:"Frequency", v:frequency==="once"?"One-time":frequency.charAt(0).toUpperCase()+frequency.slice(1)},
                    {l:"Method",    v:payMethod==="paystack"?"Card / USSD":payMethod==="flutterwave"?"Flutterwave":"Bank Transfer"},
                  ].map((r,i)=>(
                    <div key={i} style={{display:"flex",justifyContent:"space-between",padding:"8px 0",borderBottom:i<3?"1px solid rgba(255,255,255,0.04)":"none"}}>
                      <div style={{fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:2,textTransform:"uppercase",color:"rgba(255,255,255,0.3)"}}>{r.l}</div>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,color:r.gold?"#F5A800":"#fff"}}>{r.v}</div>
                ...
                <div style={{textAlign:"center",marginTop:12,fontFamily:"Rajdhani,sans-serif",fontSize:12,letterSpacing:1,color:"rgba(255,255,255,0.15)"}}>
                  🔒 Encrypted &amp; Secure · Powered by {payMethod==="flutterwave"?"Flutterwave":"Paystack"}
                </div>
              </div>
            )}
            ...
            {step===4&&(
              <div style={{textAlign:"center",padding:"40px 0",animation:"gp-fadeUp 0.6s ease forwards"}}>
                ...
                <h2 style={{fontFamily:"Cinzel,serif",fontSize:isMobile?28:36,fontWeight:700,color:"#fff",marginBottom:10}}>Thank You, {name.split(" ")[0]}! 🙏</h2>
                <p style={{fontFamily:"Cormorant Garamond,serif",fontSize:20,fontStyle:"italic",color:"rgba(255,255,255,0.55)",maxWidth:400,margin:"0 auto 28px",lineHeight:1.8}}>
                  Your gift of <span style={{color:"#F5A800",fontWeight:700}}>{payMethod==="flutterwave" && currency!=="NGN" ? `${currencySymbol}${flutterwaveChargeAmount.toLocaleString(undefined,{maximumFractionDigits:2})}` : `₦${Number(amount).toLocaleString()}`}</span> to {fund?.title} is received.<br />God's return is a hundredfold. 🌱
                </p>
                {payMethod==="transfer"&&(
                  <>
                    <div style={{background:"rgba(34,197,94,0.07)",border:"1px solid rgba(34,197,94,0.25)",borderRadius:6,padding:"16px 20px",marginBottom:12,fontFamily:"Rajdhani,sans-serif",fontSize:14,color:"rgba(255,255,255,0.6)",lineHeight:2,textAlign:"left",maxWidth:420,margin:"0 auto 12px"}}>
