        ...
        <div style={{
          ...
          <div>
            <div style={{
              ...
              fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 5,
            ...
            <h2 style={{
              ...
              fontSize: width < 480 ? 28 : width < 768 ? 36 : 48,
            ...
            <p style={{
              ...
              fontSize: width < 480 ? 18 : 20, fontWeight: 300, fontStyle: "italic",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
            ...
            {width >= 480 && (
              <button onClick={onSeeMore} style={{
                fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 3,
        ...
        <div style={{
          ...
          {carouselEvents.map((ev) => {
            ...
            return (
              ...
              >
                <div style={{ height: width < 480 ? 210 : width < 768 ? 230 : 260, overflow: "hidden", position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3,
                    textTransform: "uppercase", fontWeight: 700, padding: "5px 13px",
                ...
                <div style={{ padding: width < 480 ? "22px 20px 26px" : "26px 28px 30px" }}>
                  <div style={{
                    fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 4,
                    textTransform: "uppercase", color: ev.accentColor, marginBottom: 10, fontWeight: 700,
                  }}>{ev.dateLabel || ev.recurring}</div>

                  <div style={{
                    fontFamily: "Cinzel, serif", fontSize: width < 480 ? 20 : 23,
                    fontWeight: 700, lineHeight: 1.25, marginBottom: 12, color: ev.textColor,
                  }}>{ev.title}</div>

                  <div style={{
                    fontFamily: "Cormorant Garamond, serif", fontSize: width < 480 ? 17 : 18,
                    fontWeight: 300, fontStyle: "italic", lineHeight: 1.7,
                    color: ev.bgColor === "#fff" ? "rgba(0,0,0,0.6)" : "rgba(255,255,255,0.6)",
                    marginBottom: 22, display: "-webkit-box", WebkitLineClamp: 3,
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{
                      ...
                      <svg width="13" height="13" fill="none" stroke={ev.accentColor} strokeWidth="2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <div style={{ background: "#0A0A0A", color: "#fff", fontFamily: "'Cormorant Garamond', serif", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <button onClick={onBack} style={{
          background: "transparent", border: "1px solid rgba(255,255,255,0.2)",
          color: "#fff", fontFamily: "Rajdhani, sans-serif", fontSize: 13,
          letterSpacing: 3, textTransform: "uppercase", fontWeight: 700,
          padding: "11px 24px", borderRadius: 2, cursor: "pointer", transition: "all 0.3s",
        }}
          onMouseEnter={(e) => { e.currentTarget.style.borderColor = "#F5A800"; e.currentTarget.style.color = "#F5A800"; }}
          onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.2)"; e.currentTarget.style.color = "#fff"; }}
        >
        ...
        <span style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 3, textTransform: "uppercase", color: "rgba(255,255,255,0.4)" }}>
          Events
        </span>
      </div>
          ...
          <div style={{ position: "relative", zIndex: 2, padding: isMobile ? "60px 20px 48px" : "0 64px 80px", maxWidth: 820 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 24 }}>
              <div style={{
                ...
                <span style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: 30, lineHeight: 1 }}>{formatDay(featured.startDate)}</span>
                <span style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 3, color: "#F5A800", marginTop: 5 }}>{formatMonth(featured.startDate)}</span>
              </div>
              <div style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 14, letterSpacing: 3, textTransform: "uppercase", color: "rgba(255,255,255,0.6)" }}>
                {featured.dateLabel}
              </div>
            </div>

            <h1 style={{
              fontFamily: "Cinzel, serif", fontSize: isMobile ? "36px" : "64px",
              fontWeight: 700, lineHeight: 1.1, margin: "0 0 16px 0",
            }}>{featured.title}</h1>

            <p style={{
              fontStyle: "italic", fontWeight: 300, fontSize: isMobile ? 19 : 22,
              color: "rgba(255,255,255,0.65)", marginBottom: 24, maxWidth: 600, lineHeight: 1.7,
            }}>{featured.desc}</p>

            <div style={{
              display: "flex", flexWrap: "wrap", gap: 24,
              fontFamily: "Rajdhani, sans-serif", fontSize: 14, letterSpacing: 2,
              color: "rgba(255,255,255,0.6)", textTransform: "uppercase", marginBottom: 32,
            }}>
              <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <svg width="15" height="15" fill="none" stroke="#F5A800" strokeWidth="2" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 1118 0z"/><circle cx="12" cy="10" r="3"/></svg>
                {featured.location}
              </span>
            </div>
            ...
            <div style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
              <button onClick={() => onSelectEvent(featured.id)} style={{
                ...
                padding: "14px 32px", borderRadius: 2, display: "inline-flex",
      ...
      <section id="timeline-anchor" style={{ padding: isMobile ? "56px 20px" : "90px 64px" }}>
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: isMobile ? 30 : 44, lineHeight: 1.15 }}>Upcoming Gatherings</h2>
          </div>
          <p style={{ fontStyle: "italic", fontWeight: 300, color: "rgba(255,255,255,0.5)", fontSize: isMobile ? 17 : 19, maxWidth: 440, lineHeight: 1.7 }}>
            Conferences, camps and cohorts on the calendar — ordered by what's coming next.
          </p>
        </div>

        {restUpcoming.length === 0 ? (
          <p style={{ fontStyle: "italic", color: "rgba(255,255,255,0.4)", fontSize: 18, padding: "20px 0" }}>
            ...
            {restUpcoming.map((ev) => (
              <div key={ev.id} style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: isMobile ? "center" : "flex-end", paddingTop: 6 }}>
                  <span style={{ fontFamily: "Cinzel, serif", fontSize: isMobile ? 24 : 34, fontWeight: 700, lineHeight: 1 }}>{formatDay(ev.startDate)}</span>
                  <span style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 3, color: ev.accentColor, marginTop: 6 }}>{formatMonth(ev.startDate)}</span>
                </div>
                <div style={{
                ...
                <div onClick={() => onSelectEvent(ev.id)} className="ev-timeline-card" style={{
                  ...
                  <div style={{ padding: isMobile ? 22 : "30px 34px", flex: 1 }}>
                    <div style={{
                      fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3,
                      textTransform: "uppercase", fontWeight: 700, color: ev.accentColor, marginBottom: 12,
                    }}>{ev.tag} · {ev.dateLabel}</div>
                    <h3 style={{ fontFamily: "Cinzel, serif", fontSize: isMobile ? 22 : 27, fontWeight: 700, lineHeight: 1.25, margin: "0 0 12px 0" }}>{ev.title}</h3>
                    <p style={{ fontStyle: "italic", fontWeight: 300, color: "rgba(255,255,255,0.55)", fontSize: isMobile ? 17 : 18, lineHeight: 1.7, margin: "0 0 16px 0" }}>{ev.desc}</p>
                    <div style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 2, textTransform: "uppercase", color: "rgba(255,255,255,0.4)" }}>{ev.location}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section style={{ padding: isMobile ? "56px 20px" : "90px 64px", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{
            ...
            <div>
              ...
              <h2 style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: isMobile ? 30 : 44, lineHeight: 1.15 }}>Daily &amp; Recurring</h2>
            </div>
            <p style={{ fontStyle: "italic", fontWeight: 300, color: "rgba(255,255,255,0.5)", fontSize: isMobile ? 17 : 19, maxWidth: 440, lineHeight: 1.7 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(auto-fit, minmax(280px, 1fr))", gap: 20 }}>
            {daily.map((ev) => (
              <div onClick={() => onSelectEvent(ev.id)} className="ev-rhythm-card" key={ev.id} style={{
                border: "1px solid rgba(245,168,0,0.18)", borderRadius: 6, padding: 30,
                ...
                gap: 16, transition: "border-color 0.3s, transform 0.3s", position: "relative", overflow: "hidden",
                cursor: "pointer",
              }}>
                <div style={{
                  position: "absolute", top: 26, right: 26, width: 10, height: 10, borderRadius: "50%",
                  background: "#2ecc71", animation: "pulse 2.4s infinite",
                }} />
                <div style={{
                  fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3,
                  textTransform: "uppercase", fontWeight: 700, color: "#000", background: "#F5A800",
                  alignSelf: "flex-start", padding: "5px 13px", borderRadius: 2,
                }}>{ev.tag}</div>
                <h3 style={{ fontFamily: "Cinzel, serif", fontSize: 25, margin: 0 }}>{ev.title}</h3>
                <div style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 14, letterSpacing: 2, color: "rgba(255,255,255,0.7)", display: "flex", alignItems: "center", gap: 10 }}>
                  <svg width="15" height="15" fill="none" stroke="#F5A800" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                  {ev.recurring}
                </div>
                <p style={{ fontStyle: "italic", fontWeight: 300, color: "rgba(255,255,255,0.55)", fontSize: 17, lineHeight: 1.7, margin: 0 }}>{ev.desc}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      <section style={{ padding: isMobile ? "56px 20px" : "90px 64px", borderTop: "1px solid rgba(255,255,255,0.06)", paddingBottom: isMobile ? 80 : 120 }}>
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontFamily: "Cinzel, serif", fontWeight: 700, fontSize: isMobile ? 30 : 44, lineHeight: 1.15 }}>Past Events</h2>
          </div>
          <p style={{ fontStyle: "italic", fontWeight: 300, color: "rgba(255,255,255,0.5)", fontSize: isMobile ? 17 : 19, maxWidth: 440, lineHeight: 1.7 }}>
        ...
        {past.length === 0 ? (
          <p style={{ fontStyle: "italic", color: "rgba(255,255,255,0.4)", fontSize: 18, padding: "20px 0" }}>No past events yet — this archive will grow over time.</p>
        ) : (
            ...
            {past.map((ev) => (
              <div onClick={() => onSelectEvent(ev.id)} className="ev-past-card" key={ev.id} style={{
                ...
                <div style={{ padding: "20px 22px 26px" }}>
                  <div style={{ fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3, textTransform: "uppercase", color: "rgba(255,255,255,0.4)", marginBottom: 10 }}>{ev.dateLabel}</div>
                  <h3 style={{ fontFamily: "Cinzel, serif", fontSize: 20, fontWeight: 700, margin: 0, lineHeight: 1.3 }}>{ev.title}</h3>
                </div>
              </div>
            ))}
          </div>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 2, padding: isMobile ? "0 20px 36px" : "0 64px 56px", maxWidth: 900 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20, flexWrap: "wrap" }}>
            <span style={{
              fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3,
              textTransform: "uppercase", fontWeight: 700, padding: "6px 15px",
          ...
          <h1 style={{
            fontFamily: "Cinzel, serif", fontSize: isMobile ? 34 : 56,
      ...
      <section style={{ padding: isMobile ? "40px 20px 80px" : "64px 64px 110px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <div style={{
              fontFamily: "Rajdhani, sans-serif", fontSize: 12, letterSpacing: 3,
              textTransform: "uppercase", color: event.accentColor, marginBottom: 10, fontWeight: 700,
            }}>When</div>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontFamily: "Cinzel, serif", fontSize: 22, fontWeight: 700, lineHeight: 1.3 }}>
              {event.location}
            </div>
          </div>
        </div>
        ...
        <div style={{
          fontFamily: "Rajdhani, sans-serif", fontSize: 13, letterSpacing: 3,
          textTransform: "uppercase", color: event.accentColor, marginBottom: 16, fontWeight: 700,
        }}>About this gathering</div>
        <p style={{
          fontStyle: "italic", fontWeight: 300, fontSize: isMobile ? 20 : 23,
        ...
        <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginTop: 48 }}>
          <button onClick={onBack} style={{
            ...
            textTransform: "uppercase", fontWeight: 700, color: "#fff",
            background: "transparent", border: "1px solid rgba(255,255,255,0.25)",
            padding: "15px 34px", borderRadius: 2, cursor: "pointer",
          }}>← All Events</button>
        </div>
      </section>
    </div>
